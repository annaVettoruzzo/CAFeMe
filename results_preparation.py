...
plt.fill_between(range(args["per_steps"]+1), dict_accuracies_mean["fedavg_ft"]-dict_accuracies_std["fedavg_ft"], dict_accuracies_mean["fedavg_ft"]+dict_accuracies_std["fedavg_ft"], color='tab:blue', alpha=0.2)
plt.plot(dict_accuracies_mean["perfedavg"], label="perfedavg", c="tab:orange")
plt.fill_between(range(args["per_steps"]+1), dict_accuracies_mean["perfedavg"]-dict_accuracies_std["perfedavg"], dict_accuracies_mean["perfedavg"]+dict_accuracies_std["perfedavg"], color='tab:orange', alpha=0.2)
plt.plot(dict_accuracies_mean["ifca_ft"], label="ifca_ft", c="tab:green")
plt.fill_between(range(args["per_steps"]+1), dict_accuracies_mean["ifca_ft"]-dict_accuracies_std["ifca_ft"], dict_accuracies_mean["ifca_ft"]+dict_accuracies_std["ifca_ft"], color='tab:green', alpha=0.2)
plt.plot(dict_accuracies_mean["proposed_c1"], label="proposed", c="tab:red")
plt.fill_between(range(args["per_steps"]+1), dict_accuracies_mean["proposed_c1"]-dict_accuracies_std["proposed_c1"], dict_accuracies_mean["proposed_c1"]+dict_accuracies_std["proposed_c1"], color='tab:red', alpha=0.2)
